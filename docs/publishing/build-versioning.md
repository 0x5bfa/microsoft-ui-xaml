...
* [src\compiler\solutions\BuildTools.slnx](../../src/compiler/solutions/BuildTools.slnx)
...
[DownloadDotNetCoreSdk.ps1](../../tools/setup/init/scripts/DownloadDotNetCoreSdk.ps1) script (which is called by `tools\setup\init\scripts\init.cmd`):
