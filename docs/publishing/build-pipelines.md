...
Microsoft.UI.Xaml.Controls.dll tests can also be run by opening src\controls\solutions\MUXControls.slnx in Visual Studio, building within Visual Studio,
