...
To run tests from this stage locally locally, you can use tests\infra\payload\tools\scripts\create\CreateTestPayload.cmd to generate a test payload directory, and then either
...
Microsoft.UI.Xaml.Controls.dll tests can also be run by opening src\controls\MUXControls.slnx in Visual Studio, building within Visual Studio,
