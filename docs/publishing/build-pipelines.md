...
To run tests from this stage locally locally, you can use tests\infra\payload\scripts\CreateTestPayload.cmd to generate a test payload directory, and then either
