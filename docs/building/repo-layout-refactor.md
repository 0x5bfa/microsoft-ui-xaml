...
than legacy runtime source. Shared native runtime infra headers live there too,
with remaining legacy client, server, and native test consumers referencing them
through `$(RuntimeInfraTestPath)`.
