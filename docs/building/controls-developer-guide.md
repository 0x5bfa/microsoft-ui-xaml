...
### Try these fixes
a. Ensure that you launched muxcontrols.sln file after running tools\setup\init\scripts\init.cmd which sets up the appropriate environment variables.
