...
### Try these fixes
a. Ensure that you launched solutions\controls\MUXControls.sln after running tools\setup\init\scripts\init.cmd which sets up the appropriate environment variables.
