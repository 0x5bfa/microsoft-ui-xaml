...
1. [Screenshots / windows](#1-the-three-windows)
2. [Feature reference](#2-feature-reference)
3. [How to use — step by step](#3-how-to-use--step-by-step)
4. [Region definition XML](#4-region-definition-xml)
5. [Architecture & flow chart](#5-architecture--data-flow)
...
You can add your own regions by editing the **canonical** [`../XamlTimeline/Regions/XamlAppLaunch.regions.xml`](../../../../perf/tooling/XamlTimeline/Regions/XamlAppLaunch.regions.xml) and rebuilding (it's an embedded resource of the shared library).
...
(`TimelineBuilder`) live in the shared **[XamlTimeline](../../../../perf/tooling/XamlTimeline/)** library
...
> shared [`XamlTimeline`](../../../../perf/tooling/XamlTimeline/) library. The canonical
...
| Reference | Kind | Why |
|---|---|---|
| [`../XamlTimeline/XamlTimeline.csproj`](../../../../perf/tooling/XamlTimeline/) | `ProjectReference` | Shared `netstandard2.0` core: `TelemetryEvent`, `PhaseDefinition`, `EventMatcher`, `TimelineItem`, `PayloadFilter`, `RegionsLoader`, `TimelineBuilder`, and the embedded canonical `XamlAppLaunch.regions.xml`. |
