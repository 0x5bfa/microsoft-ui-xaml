...
![](../../assets/development/vs-breakpoint-action.png)
...
write up) can be found on the [WeakRefPtr documentation](../../architecture/design-notes/pointers.md#ctlweakrefptr).
...
![](../../assets/development/vs-enablepreview.png)
