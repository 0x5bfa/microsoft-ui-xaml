...
Consider placing static package content in the [WinUI nuspec](../../../build/nuspecs/Microsoft.WindowsAppSDK.WinUI.nuspec),
which defines the package payload together with the packaging targets.
...
to follow the steps in the [debugging guide](../debugging/debugging.md).
