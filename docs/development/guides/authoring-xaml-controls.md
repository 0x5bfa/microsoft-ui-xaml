...
For a deeper dive on Xaml styling, theming, and best practices, refer to [Xaml Style Guide](../../architecture/design-notes/xaml-styling-guide.md) for more info.
...
All new controls are to use brushes from this file. See [Xaml Style Guide](../../architecture/design-notes/xaml-styling-guide.md) for more info.
...
You can view them at [generic.xaml](../../../dxaml/xcp/dxaml/themes/generic.xaml).
...
For more information on how we run the localization process itself in the WinUI repo, see [localization-process.md](../releasing/localization-process.md).
