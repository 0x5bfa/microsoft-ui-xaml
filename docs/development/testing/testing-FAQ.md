...
![](../../assets/development/pipeline-testpayload-links.jpg)
...
![a dump file on the pipeline artifacts page](../../assets/development/dump-file.png)
...
See the
RunStaticTests section in the [build pipelines doc](../releasing/build-pipelines.md). TL;DR is to run build\PipelineScripts\VerifyWinMDCompat.ps1.
