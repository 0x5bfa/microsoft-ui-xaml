...
For a higher-level overview on authoring a control, refer to [How to Author a Xaml Control](../../development/guides/authoring-xaml-controls.md).
...
An example from [InfoBadge_themeresources.xaml](../../../controls/dev/InfoBadge/InfoBadge_themeresources.xaml),
