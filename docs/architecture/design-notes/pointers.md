...
![General case of when to use smart pointer, raw pointer based on lifetime of object](../../assets/development/pointers1.jpg)

* In a C++/WinRT project / controls folder

![Case of when to use smart pointer, COM pointer or STL pointer in a C++/WinRT project](../../assets/development/pointers2.jpg)
 
* In core and dxaml layers of WinUI codebase
 
 ![Core and dxaml layers of WinUI - using xref_ptr , comPtr](../../assets/development/pointers3.jpg)
