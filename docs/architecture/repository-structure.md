...
Control implementations are organized by control under `/controls/dev`; shared control infrastructure is under `/controls`.
...
For more information on the build system, see the [build system design](../development/building/build-system-design.md).
