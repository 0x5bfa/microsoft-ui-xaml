...
![Screenshot of Build and run options](../assets/external/binlog-images/buildandrunoptions.png)

3. Go to View->Other Windows->Build Logging:<br/>
![Screenshot of Build Logging menu item](../assets/external/binlog-images/buildlogging_menuitem.png)

4. To start taking logs, press the play button:<br/>
![Screenshot of Build Logging window](../assets/external/binlog-images/buildlogging_window.png)
