...
> For *what* the instrumentation does, see [framework-side changes](framework-side-changes.md).
> For *how the consumer* (profiler app + tap) uses it, see [the profiler implementation](profiler.md).
