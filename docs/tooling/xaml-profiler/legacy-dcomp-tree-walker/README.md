...
| [dcomp-tree-viewer.md](dcomp-tree-viewer.md) | The original deep-dive design doc: how the comp/visual trees relate, where the hooks live, the XML schema, and the throttling model. |
...
See [dcomp-tree-viewer.md](dcomp-tree-viewer.md) for the full design, XML schema, and attribute list.
