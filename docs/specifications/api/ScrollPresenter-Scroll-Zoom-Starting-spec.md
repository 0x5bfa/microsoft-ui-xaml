...
| `ScrollPresenter` API Specification | [ScrollPresenter API spec](../../architecture/design-notes/ScrollPresenter-spec.md) |
| `ScrollView` API Specification      | [ScrollView API spec](../../architecture/design-notes/ScrollView-spec.md)           |
