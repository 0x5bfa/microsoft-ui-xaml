...
1. Follow the instructions to [clone the WinUI repo](../../development/building/developer-guide.md#clone-the-winui-repo).
...
1. Using the instructions in the [Testing FAQ](../../development/testing/testing-FAQ.md), run `testmachine-prerun.cmd` if it has not
already been run.
