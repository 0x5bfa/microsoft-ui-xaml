...
control in the repo:
- [GenerateNewControlInProject.cmd](../../controls/tools/ControlGeneration/GenerateNewControlInProject.cmd)
- [GenerateNewControlProject.cmd](../../controls/tools/ControlGeneration/GenerateNewControlProject.cmd)
