...
Controls tooling scripts use the shared command wrappers under `/tools/common/scripts`.
...
helpers under `/tests/runtime/resources/tools/scripts`; runtime test package
