...
The full fingerprint table lives in [`src/OSFrameworkLens/Fingerprints/frameworks.json`](../../../Samples/OSFrameworkLensWinui3/src/OSFrameworkLens/Fingerprints/frameworks.json)
and can be edited without recompiling the matcher logic.

## Classification reference

The exact scoring formula from [`FrameworkClassifier.cs`](../../../Samples/OSFrameworkLensWinui3/src/OSFrameworkLens/Detection/FrameworkClassifier.cs):
...
Signal shorthand: **U** = UIA FrameworkId match (+5), **C** = class regex match against the HWND class *or* UIA ClassName (+4), **M**<sub>n</sub> = *n* matching modules (+n). Verbatim from [`Fingerprints/frameworks.json`](../../../Samples/OSFrameworkLensWinui3/src/OSFrameworkLens/Fingerprints/frameworks.json).
...
From [`ModuleInspector.cs`](../../../Samples/OSFrameworkLensWinui3/src/OSFrameworkLens/Detection/ModuleInspector.cs):
...
MIT. See [LICENSE](../../../Samples/OSFrameworkLensWinui3/LICENSE).
