...
ships in-box. Deeper architecture notes live in [AGENTS.md](../../Samples/TableViewSampleApp/AGENTS.md).
...
app manifest is augmented — see [AGENTS.md](../../Samples/TableViewSampleApp/AGENTS.md).
