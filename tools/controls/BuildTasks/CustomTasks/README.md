...
- Build CustomTasks.sln for Release
  - Under `tools\controls\BuildTasks`, run `MSBuild.exe CustomTasks.sln /restore /p:Configuration=Release /p:Platform="Any CPU"`
...
- Under `tools\controls\BuildTasks\CustomTasks\NuSpecs`, run `UpdateReferences.cmd`
      If you get an error :
        ...
        At D:\microsoft-ui-xaml-lift\tools\controls\BuildTasks\CustomTasks\NuSpecs\UpdateReferences.ps1:61 char:5
