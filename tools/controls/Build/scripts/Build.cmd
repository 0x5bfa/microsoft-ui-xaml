...
if "%EnvironmentInitialized%" == "" (
    echo Please run %RepoRoot%\tools\setup\init\scripts\init.cmd to ensure environment is properly initialized
    exit /b 1
)

if "%_targetMUXControls%" == "1" (
    call :buildMockPackage
    call :buildSolution %reporoot%\controls\solutions\MUXControls.sln /m
