...
if not exist %vswhere% (echo VSWhere.exe not found. Install MSBuild first from tools\setup\bootstrap\scripts\OneTimeSetup.cmd && exit /b 1)
...
if exist "%_root%\.buildtools" (
  echo Using MSBuild from .buildtools directory...
  set MSBuildInstallPath=%_root%\.buildtools
) else (
