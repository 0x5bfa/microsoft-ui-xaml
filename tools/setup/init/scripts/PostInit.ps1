...
. $repoRoot\tools\setup\init\scripts\DownloadDotNetCoreSdk.ps1
. $repoRoot\tools\setup\init\scripts\DownloadDotNetRuntimeInstaller.ps1
...
$projectPackages = @(
    ...
    (Join-Path $repoRoot 'src\runtime\solutions\Microsoft.UI.Xaml.Runtime.slnx'),
