...
$installed = LaunchSetupAndWait vs_buildtools.exe  -ArgumentList " --add Microsoft.VisualStudio.Workload.MSBuildTools --config $PSScriptRoot\..\..\vsconfig\winui.vsconfig --wait"
if (!$installed)
{
