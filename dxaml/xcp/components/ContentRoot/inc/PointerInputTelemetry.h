...
#pragma warning(suppress: 6387)     // Following existing practice of suppressing C6387 for DECLARE_TRACELOGGING_CLASS, e.g., /src/controls/Telemetry/MuxcTraceLogging.h.
...
{
    #pragma warning(suppress: 6387)     // Following existing practice of suppressing C6387 for IMPLEMENT_TELEMETRY_CLASS, e.g., /src/controls/Telemetry/MuxcTraceLogging.h.
