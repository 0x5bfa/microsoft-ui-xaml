...
set PATH=%RepoRoot%\.buildtools\MSBuild\Current\Bin\amd64;%RepoRoot%\.tools;%RepoRoot%\.tools\VSS.NuGet.AuthHelper;%RepoRoot%\tools;%RepoRoot%\tools\build;%RepoRoot%\tools\clang;%RepoRoot%\dxaml\scripts;%PATH%
