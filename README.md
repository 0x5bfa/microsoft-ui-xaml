![WinUI hero image](docs/assets/external/header.png)
...
<p align="center">
  <img src="docs/assets/external/winui_os.png" alt="Powers key experiences in Windows" width="480"/>
</p>
...
<p align="center">
<img src="docs/assets/external/winui-gallery.png" alt="WinUI 3 Gallery" width="400"/>
</p>
<p align="center">
  <a style="text-decoration:none" href="https://apps.microsoft.com/detail/9P3JFPWWDZRC?launch=true&mode=full">
    <picture>
      <source media="(prefers-color-scheme: light)" srcset="docs/assets/external/StoreBadge-dark.png" width="220" />
      <img src="docs/assets/external/StoreBadge-light.png" width="220" />
  </picture></a>
</p>
...
The WinUI team welcomes your feedback! To understand how we handle incoming feature requests and bugs, please see our [contribution handling](docs/contributing/contribution-handling.md) guidelines.
...
> limitations, see [Getting started with building WinUI](docs/getting-started/building-winui.md). See the
