...
call "%HELIX_CORRELATION_PAYLOAD%\scripts\helix\perf\RunPerfWorkItemHelper.cmd" packaged XamlPGO.HelloWorld.Cs %MODULES% 40000

set MODULES=Microsoft.UI.Xaml.dll!Microsoft.UI.Xaml.Controls.dll!Microsoft.UI.Xaml.Phone.dll!%IXP_MODULES%
call "%HELIX_CORRELATION_PAYLOAD%\scripts\helix\perf\RunPerfWorkItemHelper.cmd" packaged XamlPGO.CommonControls1 %MODULES% 15000

set MODULES=Microsoft.UI.Xaml.dll!Microsoft.UI.Xaml.Controls.dll
call "%HELIX_CORRELATION_PAYLOAD%\scripts\helix\perf\RunPerfWorkItemHelper.cmd" unpackaged SimpleIslandApp %MODULES% 50000
